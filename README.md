...
To run all tests cd into the project folder. Then run the following command.
	...
	python test/python-selenium/full_runner.py

To run individual tests you can simply run

	python python-selenium-tests/test_name_test.py

You can also run a suite of tests by importing them into a file. See full_suite.py or smoke_suite.py for how the tests are imported. Or run a set of commands with something like this.

	python python-selenium-tests/smoke_suite.py
