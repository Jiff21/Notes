...
module.exports = {
	...
	'The Javascript page should a button that changes the color of the header': function(browser) {
		browser
			.url(browser.globals.baseURL + 'Views/javascript.html')
	...
	'The Javascript page should a specific hero image': function(browser) {
		var expectURL = 'url("' + browser.globals.baseURL + 'images/JFKAlienHunter.jpg")';

		browser
			.url(browser.globals.baseURL + 'Views/javascript.html')
			.waitForElementVisible('body.javascript-body', 3000)
			.assert.cssProperty('div.jumbotron', 'background-image', expectURL)
			.end();
	}
